...
Page({
  ...
  onLoad: function (options) {
    ...
    this.getComList(this.data.page, prodId);
  },
  ...
  onPullDownRefresh: function () {
    ...
    this.getComList(pages, this.data.productId);
  },
  ...
  getComList: function (pages,prodId) {
    var that = this;
    //提示加载中
    Toast.loading({
      mask: true,
    ...
    wx.request({
      url: app.globalData.baseRequestUrl + '/CommentsController/findProComment',
      data: {
        productId: prodId,
        page: pages,
