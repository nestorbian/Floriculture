...
public class ProductController extends BaseController {
	...
	public Result<ProductWithSingleImage> getProductWithSingleImage(
	...
	public Result<ProductDetailView> findProductById(@PathVariable(name = "productId") String productId)
			throws Exception {
